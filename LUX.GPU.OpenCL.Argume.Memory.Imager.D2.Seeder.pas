...
type //$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$【型】
     ...
     TCLSeeder2D<TCLContex_,TCLPlatfo_:class> = class;

     //$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$【レコード】

     //$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$【クラス】

     //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% TCLSeeder2D<TCLContex_,TCLPlatfo_>

     TCLSeeder2D<TCLContex_,TCLPlatfo_:class> = class( TCLImager2D<TCLContex_,TCLPlatfo_,TUInt32xRGBA> )
     private
...
function TCLSeeder2D<TCLContex_,TCLPlatfo_>.GetPixChan :T_cl_channel_order;
begin
     Result := CL_RGBA;
end;

function TCLSeeder2D<TCLContex_,TCLPlatfo_>.GetPixType :T_cl_channel_type;
begin
...
function TCLSeeder2D<TCLContex_,TCLPlatfo_>.CreateHandle :T_cl_int;
begin
     inherited;
...
constructor TCLSeeder2D<TCLContex_,TCLPlatfo_>.Create( const Contex_:TCLContex_; const Queuer_:TCLQueuer_ );
begin
     inherited;
...
destructor TCLSeeder2D<TCLContex_,TCLPlatfo_>.Destroy;
begin
     _Execut.Free;
