...
type //$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$【型】
     ...
     TCLKernels     <TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_:class> = class;
       TCLKernel    <TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_:class> = class;
     ...
     //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>
     ...
     //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% TCLKernels<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>
...
function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetInfo<_TYPE_>( const Name_:T_cl_kernel_info ) :_TYPE_;
begin
     AssertCL( clGetKernelInfo( Handle, Name_, SizeOf( _TYPE_ ), @Result, nil ), 'TCLKernel.GetInfo is Error!' );
end;

function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetInfoSize( const Name_:T_cl_kernel_info ) :T_size_t;
begin
     AssertCL( clGetKernelInfo( Handle, Name_, 0, nil, @Result ), 'TCLKernel.GetInfoSize is Error!' );
end;

function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetInfos<_TYPE_>( const Name_:T_cl_kernel_info ) :TArray<_TYPE_>;
var
   S :T_size_t;
begin
     S := GetInfoSize( Name_ );
...
function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetInfoString( const Name_:T_cl_kernel_info ) :String;
begin
...
function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetArgInfo<_TYPE_>( const I_:T_cl_uint; const Name_:T_cl_kernel_arg_info ) :_TYPE_;
begin
     AssertCL( clGetKernelArgInfo( Handle, I_, Name_, SizeOf( _TYPE_ ), @Result, nil ), 'TCLKernel.GetArgInfo is Error!' );
end;

function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetArgInfoSize( const I_:T_cl_uint; const Name_:T_cl_kernel_arg_info ) :T_size_t;
begin
     AssertCL( clGetKernelArgInfo( Handle, I_, Name_, 0, nil, @Result ), 'TCLKernel.GetArgInfoSize is Error!' );
end;

function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetArgInfos<_TYPE_>( const I_:T_cl_uint; const Name_:T_cl_kernel_arg_info ) :TArray<_TYPE_>;
var
   S :T_size_t;
begin
...
function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetArgInfoString( const I_:T_cl_uint; const Name_:T_cl_kernel_arg_info ) :String;
begin
...
function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetHandle :T_cl_kernel;
begin
...
procedure TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.SetHandle( const Handle_:T_cl_kernel );
begin
...
function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetGloMinX :Integer;
begin
     Result := _GloMin.X;
end;

procedure TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.SetGloMinX( const GloMinX_:Integer );
begin
     _GloMin.X := GloMinX_;
end;

function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetGloMinY :Integer;
begin
     Result := _GloMin.Y;
end;

procedure TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.SetGloMinY( const GloMinY_:Integer );
begin
     _GloMin.Y := GloMinY_;
end;

function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetGloMinZ :Integer;
begin
     Result := _GloMin.Z;
end;

procedure TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.SetGloMinZ( const GloMinZ_:Integer );
begin
     _GloMin.Z := GloMinZ_;
end;
...
function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetGloSizX :Integer;
begin
     Result := _GloSiz.X;
end;

procedure TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.SetGloSizX( const GloSizX_:Integer );
begin
     _GloSiz.X := GloSizX_;
end;

function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetGloSizY :Integer;
begin
     Result := _GloSiz.Y;
end;

procedure TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.SetGloSizY( const GloSizY_:Integer );
begin
     _GloSiz.Y := GloSizY_;
end;

function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetGloSizZ :Integer;
begin
     Result := _GloSiz.Z;
end;

procedure TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.SetGloSizZ( const GloSizZ_:Integer );
begin
     _GloSiz.Z := GloSizZ_;
end;
...
function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetGloMaxX :Integer;
begin
     Result := GloMinX + GloSizX - 1;
end;

procedure TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.SetGloMaxX( const GloMaxX_:Integer );
begin
     GloSizX := GloMaxX_ - GloMinX + 1;
end;

function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetGloMaxY :Integer;
begin
     Result := GloMinY + GloSizY - 1;
end;

procedure TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.SetGloMaxY( const GloMaxY_:Integer );
begin
     GloSizY := GloMaxY_ - GloMinY + 1;
end;

function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetGloMaxZ :Integer;
begin
     Result := GloMinZ + GloSizZ - 1;
end;

procedure TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.SetGloMaxZ( const GloMaxZ_:Integer );
begin
...
function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetGloDimN :Integer;
begin
...
function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetKERNEL_FUNCTION_NAME :String;
begin
     Result := GetInfoString( CL_KERNEL_FUNCTION_NAME );
end;

function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetKERNEL_NUM_ARGS :T_cl_uint;
begin
     Result := GetInfo<T_cl_uint>( CL_KERNEL_NUM_ARGS );
end;

function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetKERNEL_REFERENCE_COUNT :T_cl_uint;
begin
     Result := GetInfo<T_cl_uint>( CL_KERNEL_REFERENCE_COUNT );
end;

function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetKERNEL_CONTEXT :T_cl_context;
begin
     Result := GetInfo<T_cl_context>( CL_KERNEL_CONTEXT );
end;

function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetKERNEL_PROGRAM :T_cl_program;
begin
     Result := GetInfo<T_cl_program>( CL_KERNEL_PROGRAM );
end;

{$IF CL_VERSION_1_2 <> 0 }
function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetKERNEL_ATTRIBUTES :String;
begin
...
function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetKERNEL_ARG_ADDRESS_QUALIFIER( const I_:T_cl_uint ) :T_cl_kernel_arg_address_qualifier;
begin
     Result := GetArgInfo<T_cl_kernel_arg_address_qualifier>( I_, CL_KERNEL_ARG_ADDRESS_QUALIFIER );
end;

function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetKERNEL_ARG_ACCESS_QUALIFIER( const I_:T_cl_uint ) :T_cl_kernel_arg_access_qualifier;
begin
     Result := GetArgInfo<T_cl_kernel_arg_access_qualifier>( I_, CL_KERNEL_ARG_ACCESS_QUALIFIER );
end;

function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetKERNEL_ARG_TYPE_NAME( const I_:T_cl_uint ) :String;
begin
     Result := GetArgInfoString( I_, CL_KERNEL_ARG_TYPE_NAME );
end;

function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetKERNEL_ARG_TYPE_QUALIFIER( const I_:T_cl_uint ) :T_cl_kernel_arg_type_qualifier;
begin
     Result := GetArgInfo<T_cl_kernel_arg_type_qualifier>( I_, CL_KERNEL_ARG_TYPE_QUALIFIER );
end;

function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.GetKERNEL_ARG_NAME( const I_:T_cl_uint ) :String;
begin
...
function TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.DestroHandle :T_cl_int;
begin
...
constructor TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.Create;
begin
     inherited;
...
constructor TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.Create( const Execut_:TCLExecut_; const Name_:String; const Queuer_:TCLQueuer_ );
begin
...
destructor TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.Destroy;
begin
     _Parames.Free;
...
procedure TCLKernel<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.Run;
begin
     Parames.BindsOK;
...
function TCLKernels<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.Add( const Name_:String ) :TCLKernel_;
begin
     Result := TCLKernel_.Create( Execut, Name_ );
end;

function TCLKernels<TCLSystem_,TCLExecut_,TCLContex_,TCLPlatfo_>.Add( const Name_:String; const Queuer_:TCLQueuer_ ) :TCLKernel_;
begin
