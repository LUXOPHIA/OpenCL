...
type //$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$【型】
     ...
     TCLImager<TCLSystem_,TCLContex_,TCLPlatfo_:class;TValue_:record> = class;

     TCLImagerIter<TCLSystem_,TCLContex_,TCLPlatfo_:class;TValue_:record> = class;
...
function TCLImager<TCLSystem_,TCLContex_,TCLPlatfo_,TValue_>.GetKind :T_cl_mem_flags;
begin
...
function TCLImager<TCLSystem_,TCLContex_,TCLPlatfo_,TValue_>.GetStorag :TCLStorag_;
begin
     Result := TCLStorag_( inherited Storag );
end;

procedure TCLImager<TCLSystem_,TCLContex_,TCLPlatfo_,TValue_>.SetStorag( const Storag_:TCLStorag_ );
begin
...
function TCLImager<TCLSystem_,TCLContex_,TCLPlatfo_,TValue_>.GetSize :T_size_t;
begin
...
function TCLImager<TCLSystem_,TCLContex_,TCLPlatfo_,TValue_>.GetFormat :T_cl_image_format;
begin
     with Result do
     begin
...
function TCLImager<TCLSystem_,TCLContex_,TCLPlatfo_,TValue_>.GetCountX :Integer;
begin
     Result := 1;
end;

procedure TCLImager<TCLSystem_,TCLContex_,TCLPlatfo_,TValue_>.SetCountX( const CountX_:Integer );
begin
     Handle := nil;
end;

function TCLImager<TCLSystem_,TCLContex_,TCLPlatfo_,TValue_>.GetCountY :Integer;
begin
     Result := 1;
end;

procedure TCLImager<TCLSystem_,TCLContex_,TCLPlatfo_,TValue_>.SetCountY( const CountY_:Integer );
begin
     Handle := nil;
end;

function TCLImager<TCLSystem_,TCLContex_,TCLPlatfo_,TValue_>.GetCountZ :Integer;
begin
     Result := 1;
end;

procedure TCLImager<TCLSystem_,TCLContex_,TCLPlatfo_,TValue_>.SetCountZ( const CountZ_:Integer );
begin
     Handle := nil;
end;
...
function TCLImager<TCLSystem_,TCLContex_,TCLPlatfo_,TValue_>.GetDescri :T_cl_image_desc;
begin
     with Result do
     begin
          image_type        := MemTyp;
...
function TCLImager<TCLSystem_,TCLContex_,TCLPlatfo_,TValue_>.CreateHandle :T_cl_int;
var
   F :T_cl_image_format;
   D :T_cl_image_desc;
begin
...
procedure TCLImager<TCLSystem_,TCLContex_,TCLPlatfo_,TValue_>.Fill( const Value_:TValue_ );
var
   O, R :record
           X, Y, Z :T_size_t;
         end;
...
function TCLImagerIter<TCLSystem_,TCLContex_,TCLPlatfo_,TValue_>.GetImager :TCLImager_;
begin
     Result := TCLImager_( Memory );
end;

function TCLImagerIter<TCLSystem_,TCLContex_,TCLPlatfo_,TValue_>.GetValueP :PByte;
begin
     Result := Handle;
end;
...
function TCLImagerIter<TCLSystem_,TCLContex_,TCLPlatfo_,TValue_>.CreateHandle :T_cl_int;
var
   O, R :record
           X, Y, Z :T_size_t;
         end;
