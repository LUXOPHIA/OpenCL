...
type //$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$【型】
     ...
     TCLDevices<TPlatfo_:class> = class;
       TCLDevice<TPlatfo_:class> = class;
     ...
     TCLDevice<TPlatfo_:class> = class( TListChildr<TPlatfo_,TCLDevices<TPlatfo_>> )
     private
       type TCLDevices_ = TCLDevices<TPlatfo_>;
       ///// メソッド
     ...
     public
       ...
       ///// プロパティ
       property Platfo                                       :TPlatfo_                               read GetOwnere;
     ...
     TCLDevices<TPlatfo_:class> = class( TListParent<TPlatfo_,TCLDevice<TPlatfo_>> )
     private
       type TCLDevice_ = TCLDevice<TPlatfo_>;
     protected
       ///// メソッド
...
function TCLDevice<TPlatfo_>.GetDeviceInfo<_TYPE_>( const Name_:T_cl_device_info ) :_TYPE_;
begin
...
function TCLDevice<TPlatfo_>.GetDeviceInfoSize( const Name_:T_cl_device_info ) :T_size_t;
begin
...
function TCLDevice<TPlatfo_>.GetDeviceInfos<_TYPE_>( const Name_:T_cl_device_info ) :TArray<_TYPE_>;
var
   S :T_size_t;
begin
...
function TCLDevice<TPlatfo_>.GetDeviceInfoString( const Name_:T_cl_device_info ) :String;
begin
...
function TCLDevice<TPlatfo_>.GetDEVICE_ADDRESS_BITS :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_ADDRESS_BITS );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_AVAILABLE :T_cl_bool;
begin
     Result := GetDeviceInfo<T_cl_bool>( CL_DEVICE_AVAILABLE );
end;

{$IF CL_VERSION_1_2 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_BUILT_IN_KERNELS :String;
begin
     Result := GetDeviceInfoString( CL_DEVICE_BUILT_IN_KERNELS );
end;
{$ENDIF}

function TCLDevice<TPlatfo_>.GetDEVICE_COMPILER_AVAILABLE :T_cl_bool;
begin
     Result := GetDeviceInfo<T_cl_bool>( CL_DEVICE_COMPILER_AVAILABLE );
end;

{$IF CL_VERSION_1_2 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_DOUBLE_FP_CONFIG :T_cl_device_fp_config;
begin
     Result := GetDeviceInfo<T_cl_device_fp_config>( CL_DEVICE_DOUBLE_FP_CONFIG );
end;
{$ENDIF}

function TCLDevice<TPlatfo_>.GetDEVICE_ENDIAN_LITTLE :T_cl_bool;
begin
     Result := GetDeviceInfo<T_cl_bool>( CL_DEVICE_ENDIAN_LITTLE );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_ERROR_CORRECTION_SUPPORT :T_cl_bool;
begin
     Result := GetDeviceInfo<T_cl_bool>( CL_DEVICE_ERROR_CORRECTION_SUPPORT );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_EXECUTION_CAPABILITIES :T_cl_device_exec_capabilities;
begin
     Result := GetDeviceInfo<T_cl_device_exec_capabilities>( CL_DEVICE_EXECUTION_CAPABILITIES );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_EXTENSIONS :String;
begin
     Result := GetDeviceInfoString( CL_DEVICE_EXTENSIONS );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_GLOBAL_MEM_CACHE_SIZE :T_cl_ulong;
begin
     Result := GetDeviceInfo<T_cl_ulong>( CL_DEVICE_GLOBAL_MEM_CACHE_SIZE );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_GLOBAL_MEM_CACHE_TYPE :T_cl_device_mem_cache_type;
begin
     Result := GetDeviceInfo<T_cl_device_mem_cache_type>( CL_DEVICE_GLOBAL_MEM_CACHE_TYPE );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_GLOBAL_MEM_CACHELINE_SIZE :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_GLOBAL_MEM_CACHELINE_SIZE );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_GLOBAL_MEM_SIZE :T_cl_ulong;
begin
     Result := GetDeviceInfo<T_cl_ulong>( CL_DEVICE_GLOBAL_MEM_SIZE );
end;

{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_GLOBAL_VARIABLE_PREFERRED_TOTAL_SIZE :T_size_t;
begin
...
{$IF CL_VERSION_2_1 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_IL_VERSION :String;
begin
     Result := GetDeviceInfoString( CL_DEVICE_IL_VERSION );
end;
{$ENDIF}

function TCLDevice<TPlatfo_>.GetDEVICE_IMAGE2D_MAX_HEIGHT :T_size_t;
begin
     Result := GetDeviceInfo<T_size_t>( CL_DEVICE_IMAGE2D_MAX_HEIGHT );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_IMAGE2D_MAX_WIDTH :T_size_t;
begin
     Result := GetDeviceInfo<T_size_t>( CL_DEVICE_IMAGE2D_MAX_WIDTH );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_IMAGE3D_MAX_DEPTH :T_size_t;
begin
     Result := GetDeviceInfo<T_size_t>( CL_DEVICE_IMAGE3D_MAX_DEPTH );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_IMAGE3D_MAX_HEIGHT :T_size_t;
begin
     Result := GetDeviceInfo<T_size_t>( CL_DEVICE_IMAGE3D_MAX_HEIGHT );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_IMAGE3D_MAX_WIDTH :T_size_t;
begin
     Result := GetDeviceInfo<T_size_t>( CL_DEVICE_IMAGE3D_MAX_WIDTH );
end;

{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_IMAGE_BASE_ADDRESS_ALIGNMENT :T_cl_uint;
begin
...
{$IF CL_VERSION_1_2 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_IMAGE_MAX_ARRAY_SIZE :T_size_t;
begin
...
{$IF CL_VERSION_1_2 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_IMAGE_MAX_BUFFER_SIZE :T_size_t;
begin
...
{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_IMAGE_PITCH_ALIGNMENT :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_IMAGE_PITCH_ALIGNMENT );
end;
{$ENDIF}

function TCLDevice<TPlatfo_>.GetDEVICE_IMAGE_SUPPORT :T_cl_bool;
begin
     Result := GetDeviceInfo<T_cl_bool>( CL_DEVICE_IMAGE_SUPPORT );
end;

{$IF CL_VERSION_1_2 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_LINKER_AVAILABLE :T_cl_bool;
begin
     Result := GetDeviceInfo<T_cl_bool>( CL_DEVICE_LINKER_AVAILABLE );
end;
{$ENDIF}

function TCLDevice<TPlatfo_>.GetDEVICE_LOCAL_MEM_SIZE :T_cl_ulong;
begin
     Result := GetDeviceInfo<T_cl_ulong>( CL_DEVICE_LOCAL_MEM_SIZE );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_LOCAL_MEM_TYPE :T_cl_device_local_mem_type;
begin
     Result := GetDeviceInfo<T_cl_device_local_mem_type>( CL_DEVICE_LOCAL_MEM_TYPE );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_MAX_CLOCK_FREQUENCY :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_MAX_CLOCK_FREQUENCY );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_MAX_COMPUTE_UNITS :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_MAX_COMPUTE_UNITS );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_MAX_CONSTANT_ARGS :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_MAX_CONSTANT_ARGS );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_MAX_CONSTANT_BUFFER_SIZE :T_cl_ulong;
begin
     Result := GetDeviceInfo<T_cl_ulong>( CL_DEVICE_MAX_CONSTANT_BUFFER_SIZE );
end;

{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_MAX_GLOBAL_VARIABLE_SIZE :T_size_t;
begin
     Result := GetDeviceInfo<T_size_t>( CL_DEVICE_MAX_GLOBAL_VARIABLE_SIZE );
end;
{$ENDIF}

function TCLDevice<TPlatfo_>.GetDEVICE_MAX_MEM_ALLOC_SIZE :T_cl_ulong;
begin
     Result := GetDeviceInfo<T_cl_ulong>( CL_DEVICE_MAX_MEM_ALLOC_SIZE );
end;

{$IF CL_VERSION_2_1 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_MAX_NUM_SUB_GROUPS :T_cl_uint;
begin
...
{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_MAX_ON_DEVICE_EVENTS :T_cl_uint;
begin
...
{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_MAX_ON_DEVICE_QUEUES :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_MAX_ON_DEVICE_QUEUES );
end;
{$ENDIF}

function TCLDevice<TPlatfo_>.GetDEVICE_MAX_PARAMETER_SIZE :T_size_t;
begin
     Result := GetDeviceInfo<T_size_t>( CL_DEVICE_MAX_PARAMETER_SIZE );
end;

{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_MAX_PIPE_ARGS :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_MAX_PIPE_ARGS );
end;
{$ENDIF}

function TCLDevice<TPlatfo_>.GetDEVICE_MAX_READ_IMAGE_ARGS :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_MAX_READ_IMAGE_ARGS );
end;

{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_MAX_READ_WRITE_IMAGE_ARGS :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_MAX_READ_WRITE_IMAGE_ARGS );
end;
{$ENDIF}

function TCLDevice<TPlatfo_>.GetDEVICE_MAX_SAMPLERS :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_MAX_SAMPLERS );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_MAX_WORK_GROUP_SIZE :T_size_t;
begin
     Result := GetDeviceInfo<T_size_t>( CL_DEVICE_MAX_WORK_GROUP_SIZE );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_MAX_WORK_ITEM_DIMENSIONS :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_MAX_WORK_ITEM_DIMENSIONS );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_MAX_WORK_ITEM_SIZES :TArray<T_size_t>;
begin
     Result := GetDeviceInfos<T_size_t>( CL_DEVICE_MAX_WORK_ITEM_SIZES );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_MAX_WRITE_IMAGE_ARGS :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_MAX_WRITE_IMAGE_ARGS );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_MEM_BASE_ADDR_ALIGN :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_MEM_BASE_ADDR_ALIGN );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_NAME :String;
begin
     Result := GetDeviceInfoString( CL_DEVICE_NAME );
end;

{$IF CL_VERSION_1_1 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_NATIVE_VECTOR_WIDTH_CHAR :T_cl_uint;
begin
...
{$IF CL_VERSION_1_1 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_NATIVE_VECTOR_WIDTH_SHORT :T_cl_uint;
begin
...
{$IF CL_VERSION_1_1 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_NATIVE_VECTOR_WIDTH_INT :T_cl_uint;
begin
...
{$IF CL_VERSION_1_1 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_NATIVE_VECTOR_WIDTH_LONG :T_cl_uint;
begin
...
{$IF CL_VERSION_1_1 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_NATIVE_VECTOR_WIDTH_FLOAT :T_cl_uint;
begin
...
{$IF CL_VERSION_1_1 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_NATIVE_VECTOR_WIDTH_DOUBLE :T_cl_uint;
begin
...
{$IF CL_VERSION_1_1 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_NATIVE_VECTOR_WIDTH_HALF :T_cl_uint;
begin
...
{$IF CL_VERSION_1_1 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_OPENCL_C_VERSION :String;
begin
...
{$IF CL_VERSION_1_2 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_PARENT_DEVICE :T_cl_device_id;
begin
...
{$IF CL_VERSION_1_2 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_PARTITION_AFFINITY_DOMAIN :T_cl_device_affinity_domain;
begin
...
{$IF CL_VERSION_1_2 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_PARTITION_MAX_SUB_DEVICES :T_cl_uint;
begin
...
{$IF CL_VERSION_1_2 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_PARTITION_PROPERTIES :TArray<T_cl_device_partition_property>;
begin
...
{$IF CL_VERSION_1_2 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_PARTITION_TYPE :TArray<T_cl_device_partition_property>;
begin
...
{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_PIPE_MAX_ACTIVE_RESERVATIONS :T_cl_uint;
begin
...
{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_PIPE_MAX_PACKET_SIZE :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_PIPE_MAX_PACKET_SIZE );
end;
{$ENDIF}

function TCLDevice<TPlatfo_>.GetDEVICE_PLATFORM :T_cl_platform_id;
begin
     Result := GetDeviceInfo<T_cl_platform_id>( CL_DEVICE_PLATFORM );
end;

{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_PREFERRED_GLOBAL_ATOMIC_ALIGNMENT :T_cl_uint;
begin
...
{$IF CL_VERSION_1_2 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_PREFERRED_INTEROP_USER_SYNC :T_cl_bool;
begin
...
{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_PREFERRED_LOCAL_ATOMIC_ALIGNMENT :T_cl_uint;
begin
...
{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_PREFERRED_PLATFORM_ATOMIC_ALIGNMENT :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_PREFERRED_PLATFORM_ATOMIC_ALIGNMENT );
end;
{$ENDIF}

function TCLDevice<TPlatfo_>.GetDEVICE_PREFERRED_VECTOR_WIDTH_CHAR :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_PREFERRED_VECTOR_WIDTH_CHAR );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_PREFERRED_VECTOR_WIDTH_SHORT :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_PREFERRED_VECTOR_WIDTH_SHORT );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_PREFERRED_VECTOR_WIDTH_INT :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_PREFERRED_VECTOR_WIDTH_INT );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_PREFERRED_VECTOR_WIDTH_LONG :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_PREFERRED_VECTOR_WIDTH_LONG );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_PREFERRED_VECTOR_WIDTH_FLOAT :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_PREFERRED_VECTOR_WIDTH_FLOAT );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_PREFERRED_VECTOR_WIDTH_DOUBLE :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_PREFERRED_VECTOR_WIDTH_DOUBLE );
end;

{$IF CL_VERSION_1_1 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_PREFERRED_VECTOR_WIDTH_HALF :T_cl_uint;
begin
...
{$IF CL_VERSION_1_2 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_PRINTF_BUFFER_SIZE :T_size_t;
begin
     Result := GetDeviceInfo<T_size_t>( CL_DEVICE_PRINTF_BUFFER_SIZE );
end;
{$ENDIF}

function TCLDevice<TPlatfo_>.GetDEVICE_PROFILE :String;
begin
     Result := GetDeviceInfoString( CL_DEVICE_PROFILE );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_PROFILING_TIMER_RESOLUTION :T_size_t;
begin
     Result := GetDeviceInfo<T_size_t>( CL_DEVICE_PROFILING_TIMER_RESOLUTION );
end;

{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_QUEUE_ON_DEVICE_MAX_SIZE :T_cl_uint;
begin
...
{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_QUEUE_ON_DEVICE_PREFERRED_SIZE :T_cl_uint;
begin
...
{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_QUEUE_ON_DEVICE_PROPERTIES :T_cl_command_queue_properties;
begin
...
{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_QUEUE_ON_HOST_PROPERTIES :T_cl_command_queue_properties;
begin
...
{$IF CL_VERSION_1_2 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_REFERENCE_COUNT :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_REFERENCE_COUNT );
end;
{$ENDIF}

function TCLDevice<TPlatfo_>.GetDEVICE_SINGLE_FP_CONFIG :T_cl_device_fp_config;
begin
     Result := GetDeviceInfo<T_cl_device_fp_config>( CL_DEVICE_SINGLE_FP_CONFIG );
end;

//function TCLDevice<TPlatfo_>.GetDEVICE_SPIR_VERSIONS :String;
//begin
//     Result := GetDeviceInfoString( CL_DEVICE_SPIR_VERSIONS );  {定数が存在しない}
//end;

//function TCLDevice<TPlatfo_>.GetDEVICE_SUBGROUP_INDEPENDENT_FORWARD_PROGRESS :T_cl_bool;
//begin
//     Result := GetDeviceInfo<T_cl_bool>( CL_DEVICE_SUBGROUP_INDEPENDENT_FORWARD_PROGRESS );  {定数が存在しない}
//end;

{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TPlatfo_>.GetDEVICE_SVM_CAPABILITIES :T_cl_device_svm_capabilities;
begin
     Result := GetDeviceInfo<T_cl_device_svm_capabilities>( CL_DEVICE_SVM_CAPABILITIES );
end;
{$ENDIF}

//function TCLDevice<TPlatfo_>.GetDEVICE_TERMINATE_CAPABILITY_KHR :T_cl_device_terminate_capability_khr;
//begin
//     Result := GetDeviceInfo<T_cl_device_terminate_capability_khr>( CL_TERMINATE_CAPABILITY_KHR );  {変数型も定数も存在しない}
//end;

function TCLDevice<TPlatfo_>.GetDEVICE_TYPE :T_cl_device_type;
begin
     Result := GetDeviceInfo<T_cl_device_type>( CL_DEVICE_TYPE );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_VENDOR :String;
begin
     Result := GetDeviceInfoString( CL_DEVICE_VENDOR );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_VENDOR_ID :T_cl_uint;
begin
     Result := GetDeviceInfo<T_cl_uint>( CL_DEVICE_VENDOR_ID );
end;

function TCLDevice<TPlatfo_>.GetDEVICE_VERSION :String;
begin
     Result := GetDeviceInfoString( CL_DEVICE_VERSION );
end;

function TCLDevice<TPlatfo_>.GetDRIVER_VERSION :String;
begin
...
constructor TCLDevice<TPlatfo_>.Create( const Parent_:TCLDevices_; const Handle_:T_cl_device_id );
begin
     Create( Parent_ );
...
destructor TCLDevice<TPlatfo_>.Destroy;
begin
...
constructor TCLDevices<TPlatfo_>.Create;
begin
     inherited;

end;

destructor TCLDevices<TPlatfo_>.Destroy;
begin
...
procedure TCLDevices<TPlatfo_>.FindDevices;
const
