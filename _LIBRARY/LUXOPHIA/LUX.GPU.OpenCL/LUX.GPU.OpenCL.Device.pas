...
begin
     Result := GetInfo<T_size_t>( CL_DEVICE_IMAGE_MAX_ARRAY_SIZE );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_size_t>( CL_DEVICE_IMAGE_MAX_BUFFER_SIZE );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_cl_uint>( CL_DEVICE_MAX_ON_DEVICE_EVENTS );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_cl_uint>( CL_DEVICE_NATIVE_VECTOR_WIDTH_CHAR );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_cl_uint>( CL_DEVICE_NATIVE_VECTOR_WIDTH_SHORT );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_cl_uint>( CL_DEVICE_NATIVE_VECTOR_WIDTH_INT );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_cl_uint>( CL_DEVICE_NATIVE_VECTOR_WIDTH_LONG );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_cl_uint>( CL_DEVICE_NATIVE_VECTOR_WIDTH_FLOAT );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_cl_uint>( CL_DEVICE_NATIVE_VECTOR_WIDTH_DOUBLE );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_cl_uint>( CL_DEVICE_NATIVE_VECTOR_WIDTH_HALF );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_cl_device_id>( CL_DEVICE_PARENT_DEVICE );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_cl_device_affinity_domain>( CL_DEVICE_PARTITION_AFFINITY_DOMAIN );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_cl_uint>( CL_DEVICE_PARTITION_MAX_SUB_DEVICES );
end;
{$ENDIF}
...
begin
     Result := GetInfos<T_cl_device_partition_property>( CL_DEVICE_PARTITION_PROPERTIES );
end;
{$ENDIF}
...
begin
     Result := GetInfos<T_cl_device_partition_property>( CL_DEVICE_PARTITION_TYPE );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_cl_uint>( CL_DEVICE_PIPE_MAX_ACTIVE_RESERVATIONS );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_cl_uint>( CL_DEVICE_PIPE_MAX_PACKET_SIZE );
end;
{$ENDIF}

function TCLDevice<TCLPlatfo_>.GetDEVICE_PLATFORM :T_cl_platform_id;
begin
     Result := GetInfo<T_cl_platform_id>( CL_DEVICE_PLATFORM );
end;

{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TCLPlatfo_>.GetDEVICE_PREFERRED_GLOBAL_ATOMIC_ALIGNMENT :T_cl_uint;
begin
     Result := GetInfo<T_cl_uint>( CL_DEVICE_PREFERRED_GLOBAL_ATOMIC_ALIGNMENT );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_cl_bool>( CL_DEVICE_PREFERRED_INTEROP_USER_SYNC );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_cl_uint>( CL_DEVICE_PREFERRED_LOCAL_ATOMIC_ALIGNMENT );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_size_t>( CL_DEVICE_PRINTF_BUFFER_SIZE );
end;
{$ENDIF}

function TCLDevice<TCLPlatfo_>.GetDEVICE_PROFILE :String;
begin
     Result := GetInfoString( CL_DEVICE_PROFILE );
end;

function TCLDevice<TCLPlatfo_>.GetDEVICE_PROFILING_TIMER_RESOLUTION :T_size_t;
begin
     Result := GetInfo<T_size_t>( CL_DEVICE_PROFILING_TIMER_RESOLUTION );
end;

{$IF CL_VERSION_2_0 <> 0 }
function TCLDevice<TCLPlatfo_>.GetDEVICE_QUEUE_ON_DEVICE_MAX_SIZE :T_cl_uint;
begin
     Result := GetInfo<T_cl_uint>( CL_DEVICE_QUEUE_ON_DEVICE_MAX_SIZE );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_cl_uint>( CL_DEVICE_QUEUE_ON_DEVICE_PREFERRED_SIZE );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_cl_command_queue_properties>( CL_DEVICE_QUEUE_ON_DEVICE_PROPERTIES );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_cl_command_queue_properties>( CL_DEVICE_QUEUE_ON_HOST_PROPERTIES );
end;
{$ENDIF}
...
begin
     Result := GetInfo<T_cl_uint>( CL_DEVICE_VENDOR_ID );
end;

function TCLDevice<TCLPlatfo_>.GetDEVICE_VERSION :String;
begin
     Result := GetInfoString( CL_DEVICE_VERSION );
end;

function TCLDevice<TCLPlatfo_>.GetDRIVER_VERSION :String;
begin
     Result := GetInfoString( CL_DRIVER_VERSION );
end;
