...
type //$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$【型】
     ...
     TCLDevice<_TOpenCL_> = class(

     //$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$【レコード】

     //$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$【クラス】

     //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% TCLPlatform<_TOpenCL_,_TDevice_>

     TCLPlatform<_TOpenCL_:class;_TDevice_:,constructor> = class
     private
       ///// メソッド
     ...
     protected
       ...
       _Devices    :TObjectList<_TDevice_>;
       ///// アクセス
     ...
     public
       ...
       property Devices    :TObjectList<_TDevice_> read   _Devices   ;
     end;
...
function TCLPlatform<_TOpenCL_,_TDevice_>.GetPlatformInfo<_TYPE_>( const Name_:T_cl_platform_info ) :_TYPE_;
begin
...
function TCLPlatform<_TOpenCL_,_TDevice_>.GetPlatformInfoSize( const Name_:T_cl_platform_info ) :T_size_t;
begin
...
function TCLPlatform<_TOpenCL_,_TDevice_>.GetPlatformInfos<_TYPE_>( const Name_:T_cl_platform_info ) :TArray<_TYPE_>;
var
   S :T_size_t;
begin
...
function TCLPlatform<_TOpenCL_,_TDevice_>.GetPlatformInfoString( const Name_:T_cl_platform_info ) :String;
begin
...
function TCLPlatform<_TOpenCL_,_TDevice_>.GetProfile :String;
begin
     Result := GetPlatformInfoString( CL_PLATFORM_PROFILE );
end;

function TCLPlatform<_TOpenCL_,_TDevice_>.GetVersion :String;
begin
     Result := GetPlatformInfoString( CL_PLATFORM_VERSION );
end;

function TCLPlatform<_TOpenCL_,_TDevice_>.GetName :String;
begin
     Result := GetPlatformInfoString( CL_PLATFORM_NAME );
end;

function TCLPlatform<_TOpenCL_,_TDevice_>.GetVendor :String;
begin
     Result := GetPlatformInfoString( CL_PLATFORM_VENDOR );
end;

function TCLPlatform<_TOpenCL_,_TDevice_>.GetTimerReso :T_cl_ulong;
begin
...
procedure TCLPlatform<_TOpenCL_,_TDevice_>.MakeDevices;
const
...
constructor TCLPlatform<_TOpenCL_,_TDevice_>.Create( const Parent_:_TOpenCL_; const ID_:T_cl_platform_id );
var
   E :String;
begin
     inherited Create;
     ...
     _Devices    := TObjectList<_TDevice_>.Create;
...
destructor TCLPlatform<_TOpenCL_,_TDevice_>.Destroy;
begin
     _Extensions.Free;
     _Devices   .Free;
